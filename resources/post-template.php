...
//$page = 'degrowth'; // this is used to highlight the header, choose the thoughts category, and do the highlights for the 'back to' buttons
...
EOT;
        ...
        <h1 style="margin-bottom: 0;">{$row['header']}</h1>
EOT;
        include $attributes;// '../resources/post-attrs.php';
        echo <<<EOT
        {$row['text']}
    </div>
    <div id="thoughts-div">
